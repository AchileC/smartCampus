 ...
 */
final class Version20250113171551 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE acquisition_system (id INT AUTO_INCREMENT NOT NULL, room_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, db_name VARCHAR(255) NOT NULL, temperature DOUBLE PRECISION DEFAULT NULL, humidity INT DEFAULT NULL, co2 INT DEFAULT NULL, state VARCHAR(255) DEFAULT NULL, last_captured_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_13C616225E237E06 (name), UNIQUE INDEX UNIQ_13C61622628DE0D9 (db_name), UNIQUE INDEX UNIQ_13C6162254177093 (room_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
